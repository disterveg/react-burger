...
function ModalSwitch() {
  ...
  return (
    <div>
      ...
      {background && <Route path="/feed/:id"><Modal><OrderInfo showNumber modal/></Modal></Route>}
      {background && <Route path="/profile/orders/:id"><Modal><OrderInfo showNumber modal profile/></Modal></Route>}
    </div>
  )
}
